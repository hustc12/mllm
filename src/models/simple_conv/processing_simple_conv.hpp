...
#ifndef PROCESSING_SIMPLE_CONV_HPP
#define PROCESSING_SIMPLE_CONV_HPP
...
class SimpleConvProcessor final : public PreProcessor {
...
#endif // PROCESSING_SIMPLE_CONV_HPP
